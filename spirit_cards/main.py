    ...
    configuration = PygameConfiguration(
        ...
        start_scene_parameters = LoadSceneParameters(
            ...
            load_files = {
                ...
                AssetMap.TILE1[0]: AssetLoadConfiguration(type=AssetType.Image),
                AssetMap.TILE2[0]: AssetLoadConfiguration(type=AssetType.Image),
                AssetMap.TILE3[0]: AssetLoadConfiguration(type=AssetType.Image),
                AssetMap.TILE4[0]: AssetLoadConfiguration(type=AssetType.Image),
                AssetMap.TILE5[0]: AssetLoadConfiguration(type=AssetType.Image),
                AssetMap.TILE6[0]: AssetLoadConfiguration(type=AssetType.Image),
                AssetMap.TILE7[0]: AssetLoadConfiguration(type=AssetType.Image),
                AssetMap.TILE8[0]: AssetLoadConfiguration(type=AssetType.Image),
                AssetMap.TILE9[0]: AssetLoadConfiguration(type=AssetType.Image),
                AssetMap.TILE10[0]: AssetLoadConfiguration(type=AssetType.Image),
                AssetMap.TILE11[0]: AssetLoadConfiguration(type=AssetType.Image),
                AssetMap.TILE12[0]: AssetLoadConfiguration(type=AssetType.Image),
                AssetMap.TILE13[0]: AssetLoadConfiguration(type=AssetType.Image),
